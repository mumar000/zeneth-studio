  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Right: CTA (desktop) — same style as hero */}
        <Link
          href="/contact"
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="absolute top-full left-4 right-4 mt-2 md:hidden rounded-2xl bg-white/95 backdrop-blur-xl border border-black/10 shadow-2xl p-4 z-40"
          >
