...
export default function FeaturedProjectsSection() {
  ...
  return (
    <section
      ...
      className="relative bg-[#0f0a1a] z-60"
    ...
    >
      ...
      <div className="projects-sticky-container top-0 h-screen w-full flex items-center justify-center px-4 md:px-12 lg:px-20 -mt-10">
        <div className="relative w-full max-w-[1800px] h-[90vh] bg-black/40 backdrop-blur-sm border border-white/20 rounded-3xl overflow-hidden shadow-2xl shadow-purple-500/10">
