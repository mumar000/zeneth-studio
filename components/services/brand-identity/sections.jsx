      ...
      <div className="mx-auto max-w-[1836px]">
        ...
        <div className="mt-10 grid gap-4 md:mt-20 md:gap-6 lg:grid-cols-2">
          {service.proofCards.map((card, index) => (
            <Link key={card.title} href={card.href} aria-label={`View ${card.title} case study`} className="group block overflow-hidden rounded-[14px] border border-white/70 bg-white/45 shadow-[0_12px_32px_rgba(28,16,48,0.08)] backdrop-blur-xl transition-all hover:border-white hover:bg-white/55 hover:shadow-[0_18px_42px_rgba(28,16,48,0.14)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary md:rounded-[18px]">
