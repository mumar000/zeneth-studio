...
export const projects = [
  {
    ...
    closingQuote: "What does sixty years of craft look like, distilled into a single mark?",
  },

  {
    slug: "feroce",
    title: "Feroce",
    tagline: "A web platform that moves like the product it sells.",
    category: "Web & Product Design",
    cursorText: "Explore",
    tags: ["Web Design", "Web Development", "Motion"],
    accent: "#FF5A2E",
    bg: "#101820",
    description:
      "Feroce came to us with a category-defining performance bike and a website that felt nothing like it. We rebuilt the marketing and configurator experience from the frame up — fast loads, kinetic transitions, and a buying flow that turns spec pages into a ride.",
    liveUrl: "#",
    image: "/services2.webp",
    hero: { image: "/services2.webp", logoText: "feroce" },
    media: [
      {
        type: "pair",
        left: { image: "/services2.webp" },
        right: { image: "/services3.webp", bg: "#FF5A2E" },
      },
      {
        type: "quote",
        text: "Our configurator went from a tax to a feature people share. Conversion lifted 38% in the first eight weeks.",
        author: "Marco De Luca",
        role: "Head of Growth, Feroce",
        code: "FRC2210",
        date: "04 NOV 2025",
      },
      {
    ...
    closingQuote: "How do you make a website ride like the bike it's selling?",
  },

  {
    ...
    closingQuote: "How do you put a coastline on a label without ever drawing one?",
  },

  {
    ...
    bg: "#0B0F1E",
    description:
      "Vido needed a brand that could carry equal weight in pitch decks and product. We delivered a modular system — typography, motion, voice — that lets the team move fast across surfaces without ever looking improvised.",
    liveUrl: "#",
    image: "/services4.gif",
    hero: { image: "/services4.gif", logoText: "vido" },
    media: [
      {
        type: "pair",
        left: { image: "/services4.gif" },
    ...
    closingQuote: "What does a confident brand sound like when nobody is in the room?",
  },
...

  {
    ...
    closingQuote: "When does an interface stop being a feature and start being the product?",
  },

  {
    ...
    closingQuote: "What's the smallest amount of voice a studio needs before the work can take over?",
  },

  {
    ...
    liveUrl: "#",
    image: "/services4.gif",
    hero: { image: "/services4.gif", logoText: "velvet" },
    media: [
      {
        type: "pair",
        left: { image: "/services4.gif" },
    ...
    closingQuote: "How do you make a luxury feel that survives being shipped in a box?",
  },

  {
    ...
    closingQuote: "What's the difference between a powerful tool and one that respects your attention?",
  },

  {
    ...
    bg: "#1A1207",
    description:
      "Zenith needed a system that could hold seven sub-brands without ever announcing the parent louder than the work. We delivered a master identity, a naming convention, and a flexible visual rhythm shared across portfolio companies.",
    liveUrl: "#",
    image: "/services2.webp",
    hero: { image: "/services2.webp", logoText: "zenith" },
    media: [
      {
        type: "pair",
        left: { image: "/services2.webp" },
    ...
    closingQuote: "How loud should a parent brand be when its children are doing the talking?",
  },

  {
    ...
    closingQuote: "What does a product feel like when discretion is the feature?",
  },

  {
    ...
    bg: "#062B3A",
    description:
      "Oasis sells minimal-ingredient hydration to a generation tired of being marketed at. We built a storefront that argues by restraint — long blocks of negative space, two-tap checkout, and product photography that lets the water do the talking.",
    liveUrl: "#",
    image: "/services4.gif",
    hero: { image: "/services4.gif", logoText: "oasis" },
    media: [
      {
        type: "pair",
        left: { image: "/services4.gif" },
    ...
    closingQuote: "How little can a store say before it stops saying anything at all?",
  },
];
