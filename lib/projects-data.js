...
export const projects = [
  ...
  },
  {
    ...
    tagline:
      "A premium pool brand built to earn trust before the portfolio existed.",
    category: "Brand & Digital Experience",
    cursorText: "View Project",
    tags: ["Brand Identity", "Web Design", "Full Stack Development"],
    accent: "#CBAC56",
    bg: "#0C0C0C",
    description:
      "Sapphire needed to look established before it had project photography. We created a quiet-luxury identity and a lead-focused WordPress experience designed to grow with the business.",
    liveUrl: "",
    image: "/works/sapphire/hero/project-card.webp",
    hero: {
      image: "/works/sapphire/hero/pool-hero.webp",
      logoText: "Sapphire Pools",
    },
    media: [],
    closingQuote:
      "A brand that felt ready before everything else was.",
  },
  {
    slug: "arpm",
    title: "ARPM",
    tagline:
      "A stalled property platform redesigned, rebuilt, and finally brought live.",
    category: "Interface Design & Development",
    cursorText: "View Project",
    tags: ["Product Design", "Web Design", "Full Stack Development"],
    accent: "#FFB3C8",
    bg: "#F6F4EF",
    description:
      "Associated Realty Property Management had already worked with two development teams. We turned the approved direction into a responsive, production-ready property experience and shipped it.",
    liveUrl: "",
    image: "/works/arpm/hero/hero-card-2x.png",
    hero: {
      image: "/works/arpm/hero/ipad-hands-4x.png",
      logoText: "Associated Realty Property Management",
    },
    media: [],
    closingQuote: "The third team in. The first to get it live.",
  },
  {
    slug: "mogulbay",
    title: "Mogul Bay",
    ...
    bg: "#00001C",
    description:
      "Mogul Bay came to us with a stretch of coastline and a feeling. We translated it into a complete identity system, including the wordmark, palette, photography direction, and web, built to age like the timber and salt the property is made of. Every surface speaks softly, and the brand never raises its voice.",
    liveUrl: null,
...
// Route governance is explicit so mock records cannot become indexable simply
// because they exist in this file. "noindex" projects remain reviewable through
// a direct link; "unpublished" projects intentionally return 404.
export const projectPublicationStatus = {
  spreadshop: "indexable",
  sapphire: "indexable",
  arpm: "indexable",
  mogulbay: "indexable",
  "lets-grub": "indexable",
  feroce: "noindex",
  "voyager-supplements": "noindex",
};

export function getProjectPublicationStatus(slug) {
  return projectPublicationStatus[slug] || "unpublished";
}

export function getPublicProjects() {
  return projects.filter(
    (project) => getProjectPublicationStatus(project.slug) !== "unpublished",
  );
}

export function getIndexableProjects() {
  return projects.filter(
    (project) => getProjectPublicationStatus(project.slug) === "indexable",
  );
}
...
export function getNextProject(slug) {
  ...
  if (i === -1) return publicProjects[0];
  return publicProjects[(i + 1) % publicProjects.length];
}
