...
export const projects = [
  ...
  },
  {
    ...
    title: "ARPM",
    tagline:
      "A stalled property platform transformed into a modern leasing experience.",
    category: "Digital Experience",
    cursorText: "View Project",
    tags: ["Web Design", "Full Stack Development", "Product Design"],
    accent: "#870B2D",
    bg: "#870B2D",
    description:
      "Associated Realty Property Management needed more than a redesign. We preserved its legacy property system, rebuilt search around renter intent, and delivered the launch two previous teams could not complete.",
    liveUrl: "",
