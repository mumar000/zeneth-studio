...
export const projects = [
  {
    ...
    bg: "#00001C",
    description:
      "Mogulbay came to us with a stretch of coastline and a feeling. We translated it into a complete identity system — wordmark, palette, photography direction, web — built to age like the timber and salt the property is made of. Every surface speaks softly, and the brand never raises its voice.",
    liveUrl: "#",
